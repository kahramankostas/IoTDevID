...
# ## This file makes machine learning application for aggregation packets for IoTfinder  dataset with 4 diffirent group size (3, 6, 9, 12)
...
loop="IoTfinder_h_train_sk.csv"
loop2="IoTfinder_h_test_sk.csv"
